#define chain_analysis_cxx
#include "chain_analysis.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void chain_analysis::Loop()
{
//   In a ROOT session, you can do:
//      Root > .L chain_analysis.C
//      Root > chain_analysis t
...
TH1D* leading_electron = new TH1D("leading_electron","Leading electron",60,0,200);
...
TFile* output = new TFile("100k_events_emu_final_state.root","RECREATE");
output->cd();
