...
// Fri Jul  8 16:04:00 2016 by ROOT version 5.34/32
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   const Int_t kMaxParticle = 1184;
   const Int_t kMaxTrack = 196;
   const Int_t kMaxTower = 383;
   const Int_t kMaxEFlowTrack = 196;
   const Int_t kMaxEFlowPhoton = 217;
   const Int_t kMaxEFlowNeutralHadron = 169;
   const Int_t kMaxGenJet = 13;
   const Int_t kMaxJet = 13;
...
Int_t fnch::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t fnch::LoadTree(Long64_t entry)
{
